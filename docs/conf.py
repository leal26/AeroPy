...
latex_documents = [
  (master_doc, 'pyXFOIL.tex', u'pyXFOIL Documentation',
   u'Pedro Leal', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyxfoil', u'pyXFOIL Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pyXFOIL', u'pyXFOIL Documentation',
   author, 'pyXFOIL', 'One line description of project.',
   'Miscellaneous'),
]
