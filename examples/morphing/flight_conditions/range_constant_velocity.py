...
f_LD = scipy.interpolate.interp2d(
    data.values[:, -5], data.values[:, -4], data.values[:, -1], kind='cubic')
f_L = scipy.interpolate.interp2d(
    data.values[:, -5], data.values[:, -4], data.values[:, -3], kind='cubic')
