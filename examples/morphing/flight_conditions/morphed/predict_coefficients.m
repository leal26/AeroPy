...
LD_ratio = predictor([alpha_grid, v_grid, H_grid], NACA0012.performance_model);
...
LD_ratio = predictor([alpha_grid, v_grid, H_grid], NACA4415.performance_model);
...
LD_ratio = predictor([alpha_grid, v_grid, H_grid], NACA641212.performance_model);
...
LD_ratio = predictor([alpha_grid, v_grid, H_grid], glider.performance_model);
