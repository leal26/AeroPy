...
if testing == 'tracing':
    ...
    A = calculate_shape_coefficients_tracing(
        A0, other_points['y'], other_points['x'], N1, N2, chord=tip_displacement['y'], EndThickness=tip_displacement['x'])
    ...
    if morphing_direction == 'forwards':
        ...
        for i in range(len(psi_spars)):
            ...
            y = CST(np.array([psi_i*c_C]), c_C,
                    deltasz=[deltaz/2., deltaz/2.], Al=Al_C, Au=Au_C)
