...
x_B1 = [0, 0.111088563, 0.179019141, 0.232567106, 0.27826509, 0.317433824, 0.367033123, 0.425769313, 0.481887716, 0.54582566, 0.599329657, 0.658042172, 0.724577611, 0.7793719, 0.86807229]
x_B0 = [0, 0.131510417, 0.2109375, 0.294270833, 0.384114583, 0.460286458, 0.529947917, 0.598958333, 0.67578125, 0.746744792, 0.815104167, 0.889322917]
...
y_B0 = [0, -0.014878806, -0.03765024, -0.068739984, -0.108779046, -0.149511719, -0.193474559, -0.235286058, -0.281631611 ,-0.328230469, -0.375198317, -0.422476963]
y_B1 = [0, -0.009918169,-0.027765799, -0.045669235, -0.064249948, -0.082856027, -0.111124076, -0.144531309, -0.179889201, -0.223625535, -0.257699898, -0.300809688, -0.351004246, -0.399188745, -0.465998382]
lamda = 4
# w = 400
...
plt.scatter(x_B0,y_B0, c='.3', label=r'Rao: %.3f N/m, $\beta=0$' % w, edgecolors='k', zorder=2, marker='s')
...
plt.scatter(x_B1,y_B1, c='.5', label=r'Rao: %.3f N/m, $\beta=1$' % w, edgecolors='k', zorder=2, marker='s')
plt.xlim([0,1])
