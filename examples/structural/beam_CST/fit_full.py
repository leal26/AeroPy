...
# n=5
# 0.11397826, 0.10433884, 0.10241407, 0.10070566, 0.0836374,  0.11353368
# n=4
# 0.11413702, 0.10078037, 0.10756878, 0.08089564, 0.11186881, 0
# n=3
# 0.1127, 0.1043, 0.0886, 0.1050, 0
g = CoordinateSystem.CST(D=[0.11397826, 0.10433884, 0.10241407, 0.10070566, 0.0836374,  0.11353368, 0],
                         chord=x[-1], color='k', N1=.5, N2=1, deltaz=0, tol=None)
...
# b.g.internal_variables(b.length)
# b.s = np.linspace(0, b.length, 301)
# print('c0', b.g.chord)
...
print('x', x_fit)
print('y', y_fit)
rho_p_o = np.copy(b.g_p.radius_curvature(b.g_p.x1_grid, output_only=True))
rho_p_p = np.copy(b.g_p.radius_curvature(b.g_p.x1_grid, output_only=True, parametric=True))

rho_o = np.copy(b.g.radius_curvature(b.g.x1_grid, output_only=True))
rho_p = np.copy(b.g.radius_curvature(b.g.x1_grid, output_only=True, parametric=True))
plt.figure()
