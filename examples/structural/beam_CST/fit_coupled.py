...
def cst_upper(x, A0, A1, A2, A3, A4, A5):
    bu.g.D = [A0, A1, A2, A3, A4, A5]
...
def cst_lower(x, A0, A1, A2, A3, A4, A5, A6, A7):
    # print('lower', [A0, A1, A2, A3, A4, A5, A6, A7, A8])
    bl.g.D = [A0, A1, A2, A3, A4, A5, A6, A7]
...
chord = 1
abaqus = np.loadtxt('case_study_7_upper.csv', delimiter=',')
abaqus = abaqus.T
...
abaqus = np.loadtxt('case_study_7_lower.csv', delimiter=',')
abaqus = abaqus.T
abaqus = abaqus[abaqus[:, 0].argsort()]
xl = abaqus[:, 0]
yl = abaqus[:, 1]
