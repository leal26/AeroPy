...
# a.formatted_residual(format_input=format_input, x0=[0.00852888, 0.01276988, 0.0175289,  0.06193209] + [4.01902051e-03, -4.35881507e-04, -1.52044955e-02, -1.00868579e-02,
# -5.30421003e-05])
...
upper = np.loadtxt('case_study_6b_upper.csv', delimiter=',')
lower = np.loadtxt('case_study_6b_lower.csv', delimiter=',')
